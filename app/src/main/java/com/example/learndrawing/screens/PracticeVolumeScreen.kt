...
fun PracticeVolume(
    ...
    Column(
        ...
        TitleElement(text = R.string.volume)
        TextElement(text = R.string.practice_volume)
        TextElement(text = R.string.practice_volume_2)
        ImageElement(image = painterResource(id = R.drawable.practice_volume))
