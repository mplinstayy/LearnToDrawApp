...
import com.example.learndrawing.classes_volume.VolumeClass
...
import com.example.learndrawing.screens.destinations.PracticeVolumeDestination
...
fun VolumeView(
    ...
    Column (verticalArrangement = Arrangement.Top,
        ...
        Title(text = R.string.volume)
        VolumeSteps(navigator = navigator)
    }
    Column(verticalArrangement = Arrangement.Bottom,
        ...
        PracticeButton(navigator = navigator, destination = PracticeVolumeDestination.route)
    }
}
...
fun VolumeSteps(
    ...
    val finishedSteps = remember { VolumeFinishedClass.volumeFinishedList }
    ...
    LazyColumn(
        ...
        items(
            items = steps,
            itemContent = {
                VolumeStepButtons(step = it, navigator = navigator)
            }
        )
    }
}
